...
const levels = [
    ...
    { level_name:"lv11", level_number: 11, members_number: 2028, priority: "high", slug: "/lv11", upgrade_amount: 1024000, member_amount: 1024000, nextlevel_upgrade:512000,  admin_count:4052, levels_count:0}
];
  ...
  try {
    for (const level of levels) {
      await Level.updateOne(
        { level_number: level.level_number }, // Find the document by level_number
        { $set: { admin_count: level.admin_count } }, // Update the document with the new data
